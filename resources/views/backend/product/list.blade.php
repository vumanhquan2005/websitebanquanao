                            ...
                            <div class="title-header option-title d-sm-flex d-block">
                                ...
                                <div class="right-options">
                                    <ul>
                                        ...
                                        <li>
                                            <a class="btn btn-solid" href="{{ url('/admin/products/create') }}">Thêm sản
                                                phẩm</a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <table class="table all-package theme-table table-product" id="table_id">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="assets/images/product/11.png" class="img-fluid"
                                                            alt="">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-image">
                                                        <img src="assets/images/product/10.png" class="img-fluid"
                                                            alt="">
                                                    </div>
                                                </td>
